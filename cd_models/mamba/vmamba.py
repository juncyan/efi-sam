...
from mamba.ops.selective_scan_interface import selective_scan_fn, selective_scan_ref
...
def load_pretrained_ckpt(
    ...
    ckpt = paddle.load(ckpt_path, map_location='cpu')
...
# data = paddle.randn(2,3,256,256).to("cuda")
